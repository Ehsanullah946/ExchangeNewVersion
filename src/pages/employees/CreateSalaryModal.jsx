...
const CreateSalaryModal = ({ isOpen, onClose, employees, moneyTypes }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-3xl w-full max-w-2xl shadow-2xl border border-gray-200/60">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full border-2 border-gray-200 rounded-2xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300"
            >
              <option value="">Select Employee</option>
              {employees.map((employee) => (
                <option key={employee.id} value={employee.id}>
                  {employee.stakeholder.person.firstName}{' '}
                  {employee.stakeholder.person.lastName} - {employee.position}
                </option>
              ))}
            </select>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border-2 border-gray-200 rounded-2xl pl-12 pr-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300"
                  placeholder="0.00"
                />
              </div>
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              className="w-full border-2 border-gray-200 rounded-2xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300 resize-none"
          ...
          <div className="flex gap-4 pt-4">
            <button
              ...
              className="flex-1 px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-2xl hover:bg-gray-50 transition-all duration-300 hover:shadow-lg disabled:opacity-50 font-semibold"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:translate-y-0 font-semibold shadow-lg flex items-center justify-center gap-2"
            >
              {createSalaryMutation.isPending ? (
                <>
