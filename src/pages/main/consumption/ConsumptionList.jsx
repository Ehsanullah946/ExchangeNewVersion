...
const ConsumptionList = () => {
  ...
  const { search, debouncedSearch, page, limit, open } = useSelector(
    (state) => state.filters
  );
                          ...
                          >
                            ...
                            <td className="px-2 py-1">
                              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 border border-blue-200">
                                {c.MoneyType.typeName || 'N/A'}
                              </span>
                            </td>
                            <td className="px-2 py-2">
                              <div className="flex items-center gap-2">
                                <span className="font-bold text-md text-green-600">
                                  {c.expenceType?.toLocaleString()}
                                </span>
                              </div>
                            </td>
                            ...
                            <td className="px-2 py-1">
                              <div className="flex flex-col">
                                <span className="font-semibold text-gray-800">
                                  {new Date(c.eDate).toLocaleDateString()}
                                </span>
                                <span className="text-sm text-gray-500">
                                  {new Date(c.eDate).toLocaleTimeString()}
                                </span>
                              </div>
                            </td>
