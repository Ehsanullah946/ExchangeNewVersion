  ...
  return (
    <>
      <div className="grid justify-center">
        ...
        <div>
          <form>
            <div className="font-extrabold bg-blue-400 w-fit p-3 ltr:mr-4 rtl:ml-4  rounded-t-2xl text-white  text-center">
              <span>{t('Deposit')}</span>
            </div>
            <div className="grid justify-center items-center w-fit p-4 rounded-b-2xl ltr:mr-4 rtl:ml-4 md:pl-0 pr-10 border-b-2 shadow-2xl ">
              <div className="w-100">
