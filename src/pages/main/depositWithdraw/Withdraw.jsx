              ...
              <div className="w-100">
                ...
                <div className="flex gap-10 lg:flex  md:block justify-center ml-5 mr-5 mt-1">
                  ...
                  <input
                    ...
                    id="number"
                    aria-describedby="helper-text-explanation"
                    class="border border-gray-300 shadow-cyan-400 max-w-58 text-red-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 focus:outline-indigo-600"
                    required
                  />
                </div>
