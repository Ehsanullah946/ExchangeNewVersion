...
const TransferEdit = () => {
  ...
  const { data, isLoading: loadingTransfer } = useSingleTransfer(id);
  const { mutate: updateTransfer, isLoading: updating } = useUpdateTransfer();
          ...
          <form>
            <div className="font-extrabold bg-blue-400 w-full  p-3 ltr:mr-4 rtl:ml-4  rounded-t-2xl text-white  text-center">
              <span className="flex justify-center gap-3 ">
                {t('Update Send')} <RiSendPlaneLine className="mt-1" />
              </span>
            </div>
