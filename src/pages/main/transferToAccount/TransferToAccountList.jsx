          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link to="/main/transferToAccount">
              <button className="flex items-center gap-2  px-2 py-1 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95">
                <BiTransfer className="mt-1" />
                <span>{t('Transfer To Account')}</span>
              </button>
            </Link>
                          ...
                          <td colSpan="7" className="px-6 py-16 text-center">
                            <div className="flex flex-col items-center justify-center">
                              ...
                              <p className="text-gray-500 max-w-md">
                                {t(
                                  'No transferToAccount records match your search criteria. Try adjusting your search or create a new deposit.'
                                )}
                              </p>
                            </div>
                          </td>
                        ...
                        transferToAccount.map((c, index) => (
                          ...
                          >
                            ...
                            <td className="px-1 py-1">
                              <div className="flex items-center gap-2">
                                <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                  {c.FromAccount?.MoneyType?.typeName || 'U'}
                                </div>
                                <div>
                                  <p className="font-semibold text-gray-800">
                                    {c.FromAccount?.Customer?.Stakeholder
                            ...
                            <td className="px-1 py-1">
                              <div className="flex items-center gap-2">
                                <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                  {c.ToAccount?.MoneyType?.typeName || 'U'}
                                </div>
                                <div>
                                  <p className="font-semibold text-gray-800">
                                    {c.ToAccount?.Customer?.Stakeholder?.Person
                                      ?.firstName || 'Unknown'}
                                  </p>
                                  <p className="text-sm text-gray-500">
                                    {t('Receiver Account')}
