...
const SenderReceiverList = () => {
  ...
  const { phone, search, page, limit, debouncedSearch, debouncedPhone, open } =
  ...
  const { data, isLoading, error } = useSenderReceiver(
    debouncedSearch,
    debouncedPhone,
    limit,
    page
  ...
  const senderReceivers = data?.data || [];
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link to="/management/senderReceiverAdd">
              <button className="flex items-center gap-2  px-2 py-1 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95">
                ...
                <span>{t('Add New SenderReceiver')}</span>
              </button>
            </Link>
                          ...
                          <td colSpan="7" className="px-6 py-16 text-center">
                            <div className="flex flex-col items-center justify-center">
                              ...
                              <p className="text-gray-500 max-w-md">
                                {t(
                                  'No Employee records match your search criteria. Try adjusting your search or create a new Employee.'
                                )}
                              </p>
                            </div>
                          </td>
                        ...
                        senderReceivers.map((c, index) => (
                          ...
                          >
                            ...
                            <td className="px-2 py-2">
                              <div>
                                <p className="font-semibold text-gray-800">
                                  {c.Stakeholder?.job || c.job || 'Unknown'}
                                </p>
                                <p className="text-sm text-gray-500">
                                  {t('Job')}
                                </p>
                            ...
                            <td dir="ltr" className="px-2 text-center py-1">
                              <span className="px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 border border-blue-200">
                                {c.Stakeholder?.Person?.nationalCode ||
                                  c.nationalCode ||
                                  '-'}
                              </span>
                            </td>
